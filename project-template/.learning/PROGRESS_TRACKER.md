...
**Target Completion:** December 14, 2025 (4 weeks)  
**Student:** Mohit Singh  
**Workspace:** `/Users/mohitsingh/myFiles/myesp32projects/esp32-boilerplate`
...
### 🔵 Week 1: FreeRTOS Fundamentals (2/7 days started)
- ✅ Day 1: ESP-IDF vs Arduino, Build System (COMPLETED)
  - ✅ Exercise 1: Code Analysis (completed)
  - ✅ Exercise 2: Arduino Comparison (completed)
  - ✅ Exercise 3: ESP Logging Levels (completed)
- 🔄 Day 2: FreeRTOS Tasks Basics (IN PROGRESS - Ex 1)
  - 🔄 Exercise 1: Two Talking Tasks (YOU ARE HERE - ready to code!)
...
#### Day 1: ESP-IDF vs Arduino (⬜ Not Started)
...
**Exercises Completed:**
- [ ] Exercise 1: Blink LED using ESP-IDF
- [ ] Exercise 2: Compare Arduino vs ESP-IDF GPIO
- [ ] Exercise 3: Use ESP_LOG macros
